...
export const events: GameEvent[] = [
  {
    eventId: "qingyun_spirit_spring",
    title: "山澗靈泉",
    description: "你在霧氣深處找到一口微弱靈泉，泉邊留有新近妖獸足跡。",
    worldId: "qingyun_little_world",
  ...
  {
    eventId: "qingyun_old_hunter",
    title: "老獵人的警告",
    description: "山村老獵人告訴你，北坡夜裡常有青光出沒。",
    worldId: "qingyun_little_world",
    requiredIdentity: "village_orphan",
    locationId: "village",
    type: "npc",
    weight: 8,
    tags: ["identity", "npc"],
  ...
  {
    eventId: "qingyun_sect_task",
    title: "外門採藥任務",
    description: "宗門發布採藥任務，獎勵不高，但勝在安全。",
    worldId: "qingyun_little_world",
    requiredIdentity: "outer_disciple",
  ...
  {
    eventId: "qingyun_family_scroll",
    title: "半卷家傳殘法",
    description: "夜深時，你想起祖宅密格中那半卷無名心法。",
    worldId: "qingyun_little_world",
    requiredIdentity: "fallen_clan_heir",
  ...
  {
    eventId: "qingyun_rain_meditation",
    title: "雨夜悟道",
  ...
  {
    eventId: "qingyun_abandoned_cave",
    title: "廢棄洞府",
  ...
  {
    eventId: "qingyun_medicine_elder",
    title: "藥廬老人",
  ...
  {
    eventId: "qingyun_lamp_scripture",
    title: "孤燈經卷",
  ...
  {
    eventId: "qingyun_fellow_disciple",
    title: "同門邀戰",
  ...
  {
    eventId: "qingyun_spirit_stone_mine",
    title: "靈石碎脈",
  ...
  {
    eventId: "qingyun_foundation_hint",
    title: "築基前兆",
